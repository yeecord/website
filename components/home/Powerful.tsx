...
import RedGradient from "@static/home/red-gradient.svg";
...
function Feature({
    ...
    return (
        <div className="card">
            <div className="h-stack">
                <div className="p-2 bg-gradient-to-br from-orange-400 to-red-500 rounded-md text-white">
                    {icon}
                </div>
...
function Chat() {
    return (
        <div
            className={clsx(
                "card max-w-[800px] mt-2 bg-white/10 dark:bg-black/30 p-2 md:p-3 h-fit",
        ...
        >
            ...
            >
                <div
                    className={clsx(
                        "h-24 bg-gradient-to-br from-orange-400 to-red-600 rounded-xl",
            ...
            <div className="flex flex-col gap-3">
                <Message user="Money">
                    <p className="text-secondary">/announcement</p>
                </Message>
...
function ChatInput() {
    return (
        <div className="h-stack px-4 py-2 bg-gray-100 dark:bg-gray-900 rounded-xl shadow-xl">
            ...
            />
            <button
                className="rounded-full p-3 bg-orange-600 text-white"
            ...
            {avatar != null ? (
                ...
                <div
                    className={clsx(
                        ...
                        "text-lg text-white bg-gradient-to-br from-red-500 to-orange-300"
                    )}
                >
                    {user.charAt(0)}
                </div>
