...
比如Minecraft：
![Minecraft Presence](/img/discord-rpc-customize/minecraft-presence.jpg)
...
![](/img/discord-rpc-customize/vscode-presence-extension.png)

安裝完後，在Discord就能看到Rich Presence了
![](/img/discord-rpc-customize/vscode-presence.png)

狀態部分，Idling的話代表沒有在編輯檔案，有開啟檔案的話會顯示正在編輯的檔案，並且滑鼠移到大圖示上會顯示正在編輯什麼類型的檔案，移到大圖示右下角的小圖示也會顯示目前使用的軟體
![](/img/discord-rpc-customize/vscode-presence-hover.png)
...
![](/img/discord-rpc-customize/jetbrain-presence-more-settings.png)
...
### 事前準備與上傳圖片
首先，請先創建一個應用程式
![](/img/discord-rpc-customize/create-application.png)  
:::info NOTE
...
![](/img/discord-rpc-customize/application-art-assets.png)
...
![](/img/discord-rpc-customize/custom-rp-download.png)
:::info NOTE
這個軟體其實在安裝時不用管理員權限，所以如果沒有系統管理員權限的話也不用擔心的，您還是可以下載安裝檔進行安裝。
:::
下載後，請將下載到的壓縮檔解壓縮。  
解壓縮完成後請進入剛剛解壓出來的資料夾，點選``CustomRP.exe``開啟軟體  
![](/img/discord-rpc-customize/open-custom-rp.png)
:::info NOTE
若您剛剛下載安裝檔，請雙擊剛剛下載下來的安裝檔，依照安裝步驟進行安裝，然後在安裝完後開啟軟體  
![](/img/discord-rpc-customize/install-custom-rp.png)
:::
第一次啟動時，他會問您是否將使用情況分析提供給開發人員，這個......請自己決定  
![](/img/discord-rpc-customize/user-analysis.png)  
之後就會看到軟體主介面了！  
![](/img/discord-rpc-customize/custom-rp.png)
### 填入資訊
首先是ID，請先前往剛才的應用程式設定，將Application ID複製，並貼入CustomRP的ID欄位：
![](/img/discord-rpc-customize/copy-application-id.png)  
![](/img/discord-rpc-customize/paste-id-to-custom-rp.png)  
填完後，我們先按一下ID欄位旁的連線進行連線先確認ID是否正確。
如果ID欄位的底色變成綠色，恭喜您，它已經成功連線並將您的狀態設置成功了！  
![](/img/discord-rpc-customize/paste-id-success.png)
...
![](/img/discord-rpc-customize/presence-visualizer.png)
...
![](/img/discord-rpc-customize/create-a-python-file.png)
#### 開始撰寫程式碼
首先我們要先匯入等一下需要用的模組
```py showLineNumbers
...
執行程式碼！（執行結果在此圖最下方）   
![](/img/discord-rpc-customize/pypresence.png)
...
![](/img/discord-rpc-customize/create-index-js.png)
...
執行程式！（執行成果一樣圖片中間偏下處）  
![](/img/discord-rpc-customize/discord-rpc-result.png)
...
![](/img/discord-rpc-customize/rider-new-solution.png)  
...
執行成果！  
![](/img/discord-rpc-customize/rich-presence.png)