...
比如Minecraft：
![](../static/img/discord-rpc-customize/minecraft-prescene.jpg)
...
![](../static/img/discord-rpc-customize/vscode-prescene-extension.png)

安裝完後，在Discord就能看到Rich Presence了
![](../static/img/discord-rpc-customize/vscode-prescene.png)

狀態部分，Idling的話代表沒有在編輯檔案，有開啟檔案的話會顯示正在編輯的檔案，並且滑鼠移到大圖示上會顯示正在編輯什麼類型的檔案，移到大圖示右下角的小圖示也會顯示目前使用的軟體
![](../static/img/discord-rpc-customize/vscode-prescene-hover.png)
...
![](../static/img/discord-rpc-customize/jetbrain-prescene-settings.png)
...
![](../static/img/discord-rpc-customize/jetbrain-prescene-more-settings.png)
...
![](../static/img/discord-rpc-customize/prescene-visualizer.png)
...
執行程式碼！（執行結果在此圖最下方）   
![](../static/img/discord-rpc-customize/pyprescene.png)
...
![](../static/img/discord-rpc-customize/install-discord-prescene-package.png)
...
執行成果！  
![](../static/img/discord-rpc-customize/rich-prescene.png)