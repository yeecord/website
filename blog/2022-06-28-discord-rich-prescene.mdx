...
* 如果您真的很想知道程式碼每個字是什麼意義，或者不知道開發環境怎麼安裝的，請自行上網Google了解物件導向、程式語言的相關知識！或者不知道該程式語言開發環境怎麼安裝的，也請自行Google！
...
<SyntaxHighlighter language="typescript" showLineNumbers={true} style={dracula}>
...
:::info
上面的``+=``是[委派](https://docs.microsoft.com/zh-tw/dotnet/csharp/programming-guide/delegates/using-delegates)用法
:::
