...
image: /img/discordjs-command-handler-1/discordjs-command-handler-1.jpeg
---
...
![discord.js 指令 框架系統](/img/discordjs-command-handler-1/discordjs-command-handler-1.jpeg)
...
<SyntaxHighlighter language="javascript" showLineNumbers={true} style={dracula} startingLineNumber={3}>
{`client.on("ready", () => {
...
<SyntaxHighlighter language="javascript" showLineNumbers={false} style={dracula}>
