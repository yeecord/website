...
title: 如何用 discord.js 建立一個指令系統
authors: [kay]
description: "教大家簡單建立起一個 discord.js 指令系統，讓管理指令更系統性以及方便"
tags:
  [
    "Discord",
    "dc",
...
此文章會提及一些JS名詞，會盡量簡單介紹，如果您想要更深入地去瞭解那些東西，以下提供相關連結，我也會在文中的解析提供MSDN等其他平台連結讓您參考學習。
