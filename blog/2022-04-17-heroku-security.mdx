...
authors: kane
description: "Heroku 母公司 Salesforce 在 4/16 中午無預警發布 Email 給所有 Heroku，Heroku 在 Github 上的私有代碼庫在 4/9 遭到駭客竊取並被下載，他們已經緊急移除了所有有連結到 Github 並進行 Oauth 授權的客戶的 Token 金鑰，以確保客戶的私有代碼安全。"
