...
title: Heroku 遭駭！大量代碼遭駭客「偷竊」 開發者該如何自保？
authors: kane
description: "Heroku 母公司 Salesforce 在 4/16 中午無預警發布 Email 給所有客戶，信件中表示 Heroku Github 上的私有代碼庫在 4/9 遭到駭客竊取並被下載，為了保護客戶代碼的安全，他們已經緊急移除了所有有連結到 Heroku 並進行 Github OAuth 授權之客戶的金鑰，並請客戶繼續監控 Github 上是否有異常的存取紀錄。"
...
[Heroku](https://www.heroku.com/) 母公司 Salesforce 在 4/16 中午無預警發布 Email 給所有客戶，信件中表示 Heroku Github 上的私有代碼庫在 4/9 遭到駭客竊取並被下載，為了保護客戶代碼的安全，他們已經緊急移除了所有有連結到 Heroku 並進行 Github OAuth 授權之客戶的金鑰，並請客戶繼續監控 Github 上是否有異常的存取紀錄。
