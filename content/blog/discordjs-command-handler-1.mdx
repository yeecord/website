...
![discord.js 指令 框架系統](/blog/discordjs-command-handler-1/discordjs-command-handler-1.jpeg)
...
![Discord 訊息指令 構造](/blog/discordjs-command-handler-1/command-structure.png)
...
![Vscode 創建資料夾](/blog/discordjs-command-handler-1/create-folder.png)
...
![備份指令到記事本](/blog/discordjs-command-handler-1/backup-command.png)
...
![Vscode 創建指令檔案](/blog/discordjs-command-handler-1/create-command-file.png)

再來，建立指令：

<Callout type="warn">有用到 discord.js 的東西請記得匯入！（例如：`MessageEmbed`）</Callout>
...
最後，啟動機器人並輸入指令！  
![Discord 機器人 指令執行](/blog/discordjs-command-handler-1/command-execute.png)
