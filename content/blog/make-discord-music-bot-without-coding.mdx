...
authors: [kane]
description: "我知道光是要學會寫程式就是件很困難的事情對了吧，那你還不點進來看一下這篇？今天的教學是 for 完全 0 基礎，但是又很嚮往能夠製作出自己的機器人的人，本篇使用 JMusicBot 建造自己的音樂機器人"
tags:
  [
    "Discord",
    "dc",
...
![Discord](/blog/make-discord-music-bot-without-coding/discord-branding.jpg)
...
![新建應用程式](/blog/make-discord-music-bot-without-coding/new-application.png)

`Name` 那裏就填你想要你的機器人叫什麼名字，之後按下 `Create`，
然後你就會發現一大坨東西要設定，不過我們先跳過他，

![應用程式設定](/blog/make-discord-music-bot-without-coding/app.jpeg)
...
![JDK下載頁](/blog/make-discord-music-bot-without-coding/jdk.png)
...
![開啟開發者模式](/blog/make-discord-music-bot-without-coding/enable-dev-mode.png)
...
![JMusicBot Github](/blog/make-discord-music-bot-without-coding/jmusicbot-github.png)

到這個 [下載連結](https://github.com/jagrosh/MusicBot/releases/latest) 下載最新版的程式，
他會長像是 `JMusicBot-X.Y.Z.jar` 這種格式，
然後創建一個新的資料夾把他丟到裡面去

![JMusicBot Release](/blog/make-discord-music-bot-without-coding/jmusicbot-download.png)
...
![第一次設定視窗](/blog/make-discord-music-bot-without-coding/first-prompt.png)
...
![取得Token](/blog/make-discord-music-bot-without-coding/get-token.png)
...
![擁有者視窗](/blog/make-discord-music-bot-without-coding/owner-prompt.png)

去 Discord 找到自己的名字之後，按右鍵，`複製ID`，

![複製ID](/blog/make-discord-music-bot-without-coding/get-your-id.png)
...
![JMusicBot 控制台](/blog/make-discord-music-bot-without-coding/console.png)

回到控制台，你會看到一個連結像是紅線標註的地方，這會是你的機器人邀請連結，
把它貼到瀏覽器上面，然後選擇目標的伺服器之後按確定，之後按授權，
他就算是成功蹦到你的伺服器裡了！

![機器人資訊](/blog/make-discord-music-bot-without-coding/bot-info.png)
...
![JMusicBot 使用範例](/blog/make-discord-music-bot-without-coding/example.png)
...
![JMusicBot 設定檔](/blog/make-discord-music-bot-without-coding/config-prefix.png)
...
最後如果你還是很懶得自己做的話那就考慮一下 [YEE 式機器龍](/zh-tw/docs/) 吧！
