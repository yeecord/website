...
![Discord NodeJS 骰子 機器人](/blog/discordjs-dice-bot/discordjs-dice-bot.jpeg)
...
![Node.js 官網](/blog/discordjs-dice-bot/nodejs-web.png)

<Adsense />

安裝完之後，必須要先重新啟動你的電腦 (注意，是重新啟動，不是關機再開機)，重新啟動完之後，NodeJS 就成功安裝到你的電腦了！

![Node.js 安裝檔](/blog/discordjs-dice-bot/nodejs-installer.png)
...
![Notepad++ 下載](/blog/discordjs-dice-bot/notepadpp-download.png)
...
![創建 資料夾](/blog/discordjs-dice-bot/create-folder.png)

這樣就在這個資料夾路徑開啟了一個小黑框，我們將會在之後使用到這個黑框，先別急著關掉他哦！

![命令提示字元](/blog/discordjs-dice-bot/cmd-init.png)
...
![Message Intent](/blog/discordjs-dice-bot/discord-intens.png)
...
![邀請機器人](/blog/discordjs-dice-bot/invite-bot.png)
...
>
> ![NodeJS node_modules 迷因](/blog/discordjs-dice-bot/node-modules-meme.png)

## 開始寫程式

接下來打開 Notepad ++，點左上角檔案下方的加號來新增一個文件，

![Notepad++ 新增文件](/blog/discordjs-dice-bot/notepad-init.png)

新增完之後，我們先做第一次的存檔，點左上角的 `檔案` 選單，選擇另存新檔，找到你剛剛建立的資料夾，把檔名改成 index.js，底下的檔案類型成 JavaScript file

![Notepad++ 文件](/blog/discordjs-dice-bot/notepad-firstsave.png)
...
![讀取成功](/blog/discordjs-dice-bot/cmd-run.png)

![機器人上線](/blog/discordjs-dice-bot/bot-online.png)
...
![機器人回覆訊息](/blog/discordjs-dice-bot/bot-reply-first.png)
...
![機器人得到號碼](/blog/discordjs-dice-bot/bot-reply-second.png)
...
![機器人 Embed](/blog/discordjs-dice-bot/bot-reply-third.png)
...
以上就是這次的「簡易版」 Discord 骰子機器人，如果在建立或是架設時有發現問題，可以到我們的 [支援群組中的程式閒聊中](https://discord.gg/yeecord) 討論。
