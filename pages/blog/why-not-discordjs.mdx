...
而也有人發現了這個問題並製作出 [discord.js-light](https://www.npmjs.com/package/discord.js-light) 套件，可以直接覆蓋掉幾乎所有的 Manager 設定，不過因為還是第三方軟體，並不是 discord.js 自帶功能，請在使用之前注意會不會讓程式崩壞。
